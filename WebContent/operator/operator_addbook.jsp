      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li><a href="OperatorBorrowBookInfo"><i class="fa fa-database fa-fw"></i>预约读者借阅信息</a></li>
            <li><a href="/Library/operator/operator_newborrow.jsp" ><i class="fa fa-users fa-fw"></i>书籍借阅</a></li>
            <li><a href="ReadAddBookType" class="active"><i class="fa fa-sliders fa-fw"></i>添加图书</a></li>
            <c:choose>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="" class="active">添加图书</a></li>
              </ul>
            </nav>
          </div>
        </div>
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <p>请填写书籍信息</p>
            <form action="operator_addbook" class="templatemo-login-form" method="post" >
            <div class="row form-group">
                ...
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>状态</label>
                    <input type="text" class="form-control" name="state" id="state" value="可预约" readonly>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">              
                    <label>书籍ISBN号</label>
                    <input type="text" class="form-control" name="booknumber" id="booknumber" placeholder="">                  
                </div> 
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>可借阅天数</label>
                    <input type="text"  class="form-control" name="borrowday" id="borrowday" placeholder="">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>书籍作者</label>
                    <input type="text" class="form-control" name="bookauthor" id="bookauthor" placeholder="">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>书籍译者 </label>
                    <input type="text" class="form-control" name="booktranslation" id="booktranslation" placeholder="">                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                ...
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" class="form-control" name="bookstand" id="bookstand" placeholder="">
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    %>
                    <input type="text" class="form-control" value="<%=date %>" readonly name="inttime" id="inttime" placeholder="">
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="operator">图书管理员</label>
                    <input type="text" class="form-control" value="${USERBEAN.u_name }" readonly name="operator" id="operator" placeholder="">
                </div> 
              </div>
              <div class="row form-group">
              <div class="col-lg-6 col-md-6 form-group">                  
