      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li><a href="/Library/operator/operator_newborrow.jsp"  class="active"><i class="fa fa-users fa-fw"></i>书籍借阅</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <form action="OperatorNewBorrow?mans=${USERBEAN.u_name }" class="templatemo-login-form" method="post" >
	            <div class="row form-group">
	              	<div class="col-lg-6 col-md-6 form-group">                  
	                    <label>读者ID</label>
	                    <input type="text" class="form-control" name="readerID" id="readerID" placeholder="readerID">
	                </div>
	                <div class="col-lg-6 col-md-6 form-group">                  
	                    <label >书籍ID</label>
